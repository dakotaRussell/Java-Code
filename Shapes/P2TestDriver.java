...
public class P2TestDriver
{
   ...
   private static boolean testCircle()
   {
      ...
      System.out.println("Got:    " + circle.getPosition() + "     Equal:   -104, 59");
   ...
   private static boolean testWorkSpace()
   {
      ...
      pass &= test(ws.getAreaOfAllShapes() == 0, test++);
      ...
      pass &= test(approx(ws.getAreaOfAllShapes(), circles[0].getArea(), 0.000001), test++);
      ...
      pass &= test(ws.getTriangles().get(0).equals(tris[0]), test++);
